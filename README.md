# Itellicoai TypeScript API Library

[![NPM version](<https://img.shields.io/npm/v/itellicoai.svg?label=npm%20(stable)>)](https://npmjs.org/package/itellicoai) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/itellicoai)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/itellicoai-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install itellicoai`
...
1. Via the `ITELLICOAI_LOG` environment variable
...
const client = new Itellicoai({
  logger: logger.child({ name: 'Itellicoai' }),
...
const client = new Itellicoai({ fetch });
```
...
```ts
import Itellicoai from 'npm:itellicoai';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/itellicoai-typescript/issues) with questions, bugs, or suggestions.
