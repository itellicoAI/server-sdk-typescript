...
```sh
npm install git+ssh://git@github.com:itellicoAI/server-sdk-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/itellicoAI/server-sdk-typescript/issues) with questions, bugs, or suggestions.
